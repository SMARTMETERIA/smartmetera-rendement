// Miroir Deno de src/lib/ingest/types.ts (Next.js) — voir README
// de ce dossier pour l'explication de cette duplication contrôlée (même
// convention que supabase/functions/process-import/lib).
