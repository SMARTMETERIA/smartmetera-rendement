...
/**
 * Agrège un export facturation (ex. JVS, une ligne par commune) en un total
 * par exercice : balance_inputs est au niveau de l'organisation, pas de la
 * commune (voir migration 0006).
 */
